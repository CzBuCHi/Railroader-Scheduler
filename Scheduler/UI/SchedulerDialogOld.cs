...
//[Obsolete]
//public sealed class SchedulerDialogOld
//{
//    private static SchedulerDialogOld? _Shared;

//    public static SchedulerDialogOld Shared {
//        get => _Shared ??= new SchedulerDialogOld();
//        set {
//            if (_Shared != null) {
...
//    private static readonly ILogger _Logger = Log.ForContext(typeof(SchedulerDialogOld))!;

//    private readonly Window _Window = SchedulerPlugin.UiHelper.CreateWindow(800, 500, Window.Position.Center);

//    private SchedulerDialogOld() {
